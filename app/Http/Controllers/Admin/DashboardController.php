...
class DashboardController extends Controller
{
    public function index(){
        ...
        return view('admin.dashboard',compact('posts','popular_posts','total_pending_posts','all_view','author_count','active_authors','category_count','tag_count','new_authors_today'));
    }
}
